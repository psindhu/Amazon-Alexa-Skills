...
var speechHandlers = {
    'welcome' : function() {
        ...
        var message = config.welcome_message + constants.breakTime['100'] +
            ' You can ask for latest Unofficial Apple Developer News. For example, you can say tell me news. ';
        var reprompt = 'You can ask for latest news for Unofficial Apple Developers.';
    ...
    'justStarted' : function () {
        ...
        var message = 'Sorry, there are no new developer news available. ' +
    ...
    'helpStartMode' : function () {
        ...
        var message = config.welcome_message + constants.breakTime['100'] +
            ' You can ask for latest news for Unofficial Apple Developers. For example, you can say tell me developer news. ';
        this.emit(':ask', message, message);
    },
    ...
    'readItemSpeechHelper' : function () {
        ...
        if(items) {
            ...
            items.forEach(function (feed) {
                ...
                cardTitle = "Apple Developer News";
    ...
    'unhandledStartMode' : function () {
        ...
        var message = 'Sorry, to hear Unofficial Apple developer news feed, you can say give me news or tell me latest news. ';
